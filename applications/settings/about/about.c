...
static DialogMessageButton unleashed_info_screen(DialogsApp* dialogs, DialogMessage* message) {
    ...
    const char* screen_header = "LeoneWare Firmware\n";

    const char* screen_text = "Gioca con cautela.\n"
                              "Non per uso illegale!";
...
static DialogMessageButton unleashed_info_screen2(DialogsApp* dialogs, DialogMessage* message) {
    ...
    const char* screen_text = "Plugin personalizzati inclusi\n"
                              "Per aggiornamenti e informazioni visita\n"
                              "github.com/LeoneITA";
